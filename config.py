...
QUIZ_PAGE_DATA = {
    'frames': [
        ('question_frm', COLOR_DARK, 0, 0.2, 1.0, 0.3),
        ('answer_frm', COLOR_DARK, 0, 0.5, 1.0, 0.3)
    ],
    'labels': [
        ('step_lbl', COLOR_LIME, FONT_MEDIUM, 0.25, 0.1),
        ('score_lbl', COLOR_WHITE, FONT_MEDIUM, 0.7, 0.1),
        ('comment_lbl', COLOR_LIME, FONT_MEDIUM, 0.5, 0.9)
    ]
}

FINAL_PAGE_DATA = {
    'labels': [
        ('score_lbl', '', COLOR_LIME, FONT_MEDIUM, 0.5, 0.35),
        ('repeat_lbl', 'Хочешь сыграть снова?', COLOR_WHITE, FONT_MEDIUM, 0.5, 0.5)
    ],
    'buttons': [
        ('Выйти', 'exit', 0.35, 0.7),
        ('Давай!', 'start', 0.65, 0.7)
    ]
}

GAME_DATA = [
    {
        'question': 'Какая река считается\nсамой длинной в мире?',
        'answers': ['А) Амазонка', 'Б) Нил', 'В) Миссисипи'],
        'right_answer': 0
    },
    {
        'question': 'Какой фильм получил\nсамую первую премию «Оскар»\nв номинации «Лучший фильм» в 1929 году?',
        'answers': ['А) «Унесенные ветром»', 'Б) «Крылья»',  'В) «Огни большого города»'],
        'right_answer': 1
    },
    {
        'question': 'Какой химический элемент\nобозначается символом Fe\nв таблице Менделеева?',
        'answers': ['А) Фтор', 'Б) Свинец', 'В) Железо'],
        'right_answer': 2
    },
    {
        'question': 'В каком году произошло\n падение Берлинской стены?',
        'answers': ['А) 1987', 'Б) 1989', 'В) 1991'],
        'right_answer': 1
    },
    {
        'question': 'Какое животное способно\nразвивать самую высокую\nскорость бега на короткие дистанции?',
        'answers': ['А) Гепард', 'Б) Антилопа гну', 'В) Лев'],
        'right_answer': 0
    }
]
